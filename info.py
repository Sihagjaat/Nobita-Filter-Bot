...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001803321114')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002371982675').split()]
MAX_B_TN = environ.get("MAX_B_TN", "8")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+o8hZ6VXUpuo2MDZl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://telegram.me/SihagBots')
MSG_ALRT = environ.get('MSG_ALRT', 'ꜱʜᴀʀᴇ  ᴀɴᴅ  ꜱᴜᴘᴘᴏʀᴛ  ᴜꜱ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002371982675'))
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f" @SihagBots {script.CAPTION}")
